...
The initial strategy to follow for the development of the SWO MSE platform were discussed by the WPM in 2017 (IOTC 2017a). It was agreed to use the stock assessment carried out and reviewed by the WPB in 2017 (IOTC 2017b) based on SS3 - Stock Synthesis 3.24 (Methot and Wetzel 2013), as a basis for the population and fishery model to build the OM for this stock. Uncertainties concerning structural elements of the model formulation were considered to be the primary factor of concern.
...
The Figures \ref{fig:maturity} and \ref{fig:Growth} below represent the options used for maturity and growth curves.

![Age-at-maturity options for conditioning the SWO OM\label{fig:maturity}](figures/Maturity.png)

![Growth options for conditioning the SWO OM\label{fig:Growth}](figures/Growth.png)
