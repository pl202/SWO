...
Table \ref{table:grid} below summarizes the grid of uncertanties considered for the conditioning of the OM. This initial grid results in a total of XXXX models. 

Table: Grid of uncertainties used for cinditioning the swordfish OM, based on the recomendations from the 2017 WPM \label{table:grid}
