...
Table \ref{tab:tab-grid} summarizes the grid of uncertainties considered for the conditioning of the OM. This initial grid results in a total of XXXX models. 
